    ...
    <main>
              ...
              <a-row type="flex" align="center" :gutter="[36, 36]">
                ...
                >
                  <div class="txtContainer">
                    <p>
                      Liz
                      Choi是高等教育领域公认的领军人物，在开发国际教育的核心渠道方面，取得了巨大的成功，并积累了丰富的经验。她的专长几乎涵盖了发展国际学生的所有关键领域，如营销，招聘，行政以及战略合作，更重要的还有项目的前期开发，后期执行和最终评估。作为国际教育市场公认的专家，Liz
                      Choi一直是把企业级战略路线应用到教育领域的重要推动力，在政策制定，业务发展和流程开发方面具有成熟的经验。
                    </p>
                    <p>
                      Liz
              ...
              <a-row type="flex" align="center" :gutter="[36, 36]">
                ...
                >
                  <div class="txtContainer">
                    <p>
                      保罗·霍尔顿（Paul
                      Holden）在领导力和成就方面取得了非凡的记录，这些记录跨越了许多领域
                      - 从教育和劳动力培训到企业和政府。 在 2017 年 5
                      月，他受邀作为全国最大的私立高等教育机构之一的总裁头衔，即加拿大教育集团。
                    </p>
                    <p>
                      在担任现任职务之前，保罗是曼省排名第二的公立学院-曼尼
                      托巴科学技术学院的校长，总裁兼首席执行官。在他任职期间，学校无论在学生数量还是校区规模，都实现了前所未有的增长和扩张；一举奠定了保罗在业界内的地位。
                    </p>
                    <p>
                      保罗在现代教育与劳动力市场之间架设了完美的桥梁：通过与政府部门，企业雇主，教育工作者，以及学生之间的沟通与研究，
                    ...
                    <p>
                      保罗·霍尔顿（Paul
                      Holden）作为曼尼托巴公共服务的资深成员二十年来，保罗与各个领域的
                      团体合作，开发了很多举足轻重的项目，取得了重大的成功。他
                      的成功也体现在私立学校教育领域，例如，作为 Cambrian Credit
                      Union
                      的董事会主席，保罗帮助他们的资产扩大了十倍。同时拥有曼尼托巴大学政治学硕士学位，以及自然资源管理硕士学位。
                    </p>
                  </div>
                </a-col>
              </a-row>
      ...
      <div class="wrapper">
        ...
        <section class="map-row">
          <img src="/img/Recruiting/map.png" alt="" class="img-fluid" />
          <div class="info">
            <h2>加拿大4大校区</h2>
            <p>
              我们在加拿大卡尔加里，埃德蒙顿，布兰顿以及温尼伯总共有4个校区。
            </p>
            <p>我们线上课程有来自加拿大所有省份和地区的学生！</p>
          </div>
        </section>
      </div>
...
const requirements = [
  ...
  },
  {
    ...
    requirement_points: [
      {
        point: "语言级别达到CLB4 （雅思听4.5、读3.5、写4.0、说4.0）",
      },
    ],
  },
  {
