<template>
  <div class="project-detail-page">
    ...
    <section class="sec-introduction2">
      ...
      <div class="wrapper">
        <p>
          孩子年满6岁即可进入小学学习。加拿大的初中和小学合在一起共九年级，高中从十年级到十二年级，加拿大的中小学教育特点与东方国家有很大不同。主要体现在年级分配与教学方法及教育思想上，各校对教材的选择也有一定的自主权和灵活性。
        </p>
      </div>
    </section>
      ...
      schools: [
        {
          ...
          requirement_points: [
            {
              point: "公立学校是由省政府或地方政府开办和监管的，由纳税人资助，父母仅需支付少许费用供学校用品和旅行之用。学生享受免费教育。"
            }
          ]
        },
        {
          ...
          requirement_points: [
            {
              point: "教会学校是指罗马天主教会开办的学校。学生享受免费教育。"
            }
          ]
        },
        {
          ...
          requirement_points: [
            {
              point: "私立学校是私人资助或开办的。需要收费，各学校之间价格差异非常悬殊。"
            }
          ]
        },
      ],
...
.headlineBlock {
  ...
  .angle {
    height: 100%;
    width: 40px;
    background-image: linear-gradient(to top right, $navy 49.9%, transparent 50.1%);
  }
}
