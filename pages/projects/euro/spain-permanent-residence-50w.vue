<template>
  <div class="hot-projects-detail-page">
    ...
    <section id="edu-sec-fee" class="sec-fee sec-general sec-bg-gray anchor">
      <div class="wrapper">
        <h2>项目费用</h2>
        <img data-fancybox="price" class="img-fluid" src="/img/spain-1.jpeg" alt="">
        <img data-fancybox="price" class="img-fluid" src="/img/spain-2.jpeg" alt="">
      </div>
    </section>
...
export default {
  ...
  async asyncData({ $axios, route }) {
    const projectData = await $axios.$get(`/projects?slug=spain-permanent-residence-50w`);
