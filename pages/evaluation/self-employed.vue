      ...
      <a-card>
        <a-affix :offset-top="0">
          <div class="pointsCounter">
            ...
            <h2>您目前评分为：<strong>{{subtotal}}分</strong></h2>
          </div>
        </a-affix>
        <div class="form">
          <div class="section">
            ...
            <div class="box last">
              ...
              <div class="question exp">
                <div>
                  工作经验（可以不连续）<a-input-number :min="0" :max="100" v-model="exp" style="margin-right: 10px"></a-input-number> 年
                </div>
              </div>
              <div class="result">
                {{expCalc}}
...
export default {
  ...
  computed: {
    ...
    langTest1Calc: function() {
      if (this.langTest1.test == 1) {
        this.langTest1.pointsL = (
          this.langTest1.l >= 7.5 ? 6 :
          this.langTest1.l >= 5.5 ? 5 :
          this.langTest1.l >= 4.5 ? 4 : 0
        ) 
        this.langTest1.pointsS = (
          this.langTest1.s >= 6.5 ? 6 :
          this.langTest1.s >= 5.5 ? 5 :
          this.langTest1.s >= 4? 4 : 0
        ) 
        this.langTest1.pointsR = (
          this.langTest1.r >= 6.5 ? 6 :
          this.langTest1.r >= 5 ? 5 :
          this.langTest1.r >= 3.5 ? 4 : 0
        ) 
        this.langTest1.pointsW = (
          this.langTest1.w >= 6.5 ? 6 :
          this.langTest1.w >= 5.5 ? 5 :
          this.langTest1.w >= 4 ? 4 : 0
        ) 
      } else if (this.langTest1.test == 2) {
        this.langTest1.pointsL = (
          this.langTest1.l >= 280 ? 6 :
          this.langTest1.l >= 217 ? 5 :
          this.langTest1.l >= 145 ? 4 : 0
        ) 
        this.langTest1.pointsS = (
          this.langTest1.s >= 349 ? 6 :
          this.langTest1.s >= 371 ? 5 :
          this.langTest1.s >= 181 ? 4 : 0
        ) 
        this.langTest1.pointsR = (
          this.langTest1.r >= 233 ? 6 :
          this.langTest1.r >= 181 ? 5 :
          this.langTest1.r >= 121 ? 4 : 0
        ) 
        this.langTest1.pointsW = (
          this.langTest1.w >= 349 ? 6 :
          this.langTest1.w >= 271 ? 5 :
      ...
      return (
        this.langTest1.pointsL + this.langTest1.pointsS + this.langTest1.pointsR + this.langTest1.pointsW
      )
    },
    expCalc: function() {
      return (
    ...
    extraCalc: function() {
      if (
        this.eduCalcPartner + this.caEduCalc + this.caExpCalc + this.brothersCalc > 6
      ) {
        return 6
      } else {
        return (
          this.eduCalcPartner + this.caEduCalc + this.caExpCalc + this.brothersCalc
        )
      }
    },
    subtotal: function() {
